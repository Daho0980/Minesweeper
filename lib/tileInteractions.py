...
def flagTile(y, x):
    ...
    if   target == '■':          s.tileGrid[y][x] = s.icons["flag"]; print("case 1 progressed")
    elif target == s.icons["flag"]: s.tileGrid[y][x] = '■'; print("case 2 progressed")
    else:
        ...
        print(f"{tl.escapeAnsi(s.tileGrid[y][x])}, {unDIggedTile}")
